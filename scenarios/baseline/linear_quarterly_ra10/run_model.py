...
OUTPUT_DIR = '/home/realdomarp/PYMC/FACTOR ROTATION/scenarios/baseline/linear_quarterly_ra10/output'
RISK_AVERSION = 1.0  # Balanced/risk averse
...
charting.plot_all_charts(
    ...
    title_prefix='Linear Quarterly RA10'
)
