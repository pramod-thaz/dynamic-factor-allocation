...
print("=== Quarterly EMA + Smoothed HMM Strategy ===", flush=True)
...
def calculate_hmm_features_improved(returns_df, prices_df):
    """Improved features: continuous, normalized, and added market_vol"""
...
def predict_next(returns_df, ticker, current_date, span=40):
    """Faster EMA: shorter span for more responsiveness"""
...
def mean_variance_optimize(mu, sigma, previous_allocation=None, risk_aversion=0.5, turnover_penalty=0.02):
    """Added small turnover penalty to discourage unnecessary switches"""
