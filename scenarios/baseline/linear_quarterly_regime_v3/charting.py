# -*- coding: utf-8 -*-
"""
Separated Charting Module for Factor Rotation v3
"""
...
def plot_all_charts(results_df, spy_aligned, weights_history, tickers, dates, hmm_states,
    ...
    # 3. Regime timeline (SHV=0, QLD=1, SSO=2)
    ax3 = axes[2]
    regime_colors = {0: 'lightblue', 1: 'lightgreen', 2: 'salmon'}
    regime_labels = {0: 'SHV (Bear)', 1: 'QLD (Moderate)', 2: 'SSO (Bull)'}
    regime_values = [r * 40 for r in hmm_states]
    ...
    ax3.set_yticklabels([regime_labels.get(i, str(i)) for i in [0, 1, 2]])
